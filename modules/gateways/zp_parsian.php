<?php
     ...
     *::: myvahab@gmail.com
     */
function zp_parsian_config() {
    $configarray = array(
     "FriendlyName" => array("Type" => "System", "Value"=>"پرداخت آنلاین پارسیان"),
...
function zp_parsian_link($params) {
	...
	$code = '
    <form method="post" action="./zp_parsian.php">
