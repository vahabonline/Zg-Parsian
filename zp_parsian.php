<?php
	...
	$CallbackURL = $systemUrl . '/modules/gateways/callback/zp_parsian.php?invoiceid='. $_POST['invoiceid'] .'&Amount='. $Amount;
	try {
	...
	if($result->Status == 100){ 
		...
		$url = "https://$mirror.zarinpal.com/pg/StartPay/$vahabid/Pec";
		redirect($url);
	} else {
